document.addEventListener("DOMContentLoaded", () => {
    const translations = {
        es: {
            ...
            enemy_hellbat_desc: "Murciélago infernal que ataca desde el aire. Solo el mortero de roca puede derribarlo antes de que cause estragos.<br>Salud: 90.<br>Velocidad: Media.",
        ...
        en: {
            ...
            enemy_hellbat: "Hell Bat",
            enemy_hellbat_desc: "Infernal bat that attacks from the air. Only the rock mortar can bring it down before it wreaks havoc.<br>Health: 90.<br>Speed: Medium.",
            enemy_hexlord: "Hex Lord",
